    ...
    return (
        <div className="space-y-4">
            ...
            >
                ...
                {/* Character Label - Top Center on mobile, Top Left on desktop */}
                <div className="absolute top-2 left-1/2 -translate-x-1/2 md:left-3 md:translate-x-0 bg-white/95 px-2 py-0.5 md:px-3 md:py-1.5 border border-black">
                    <div className="font-bold text-[8px] md:text-sm uppercase truncate text-center md:text-left">{transformation.characterName}</div>
                    {transformation.series && (
                        <div className="text-[7px] md:text-[10px] font-mono text-gray-600 truncate text-center md:text-left">{transformation.series}</div>
                    )}
                </div>
            </div>
